class AppLinks {
  ...
  static const USER_ALARM = '/user/alarm';
  static const USER_BOOKMARK = '/user/bookmark';
  static const USER_SETTING = '/user/setting';
  static const USER_UPDATE = '/user/update';
  static const USER_ID_FIND = '/user/id/find';
  static const USER_LOGIN = '/user/login';
  static const USER_PW_FIND = '/user/pw/find';
  static const USER_SINGUP = '/user/singup';

  static const ADMIN = '/manager';
}
